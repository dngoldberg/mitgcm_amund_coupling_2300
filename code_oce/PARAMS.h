...
C     scaleBottomDragQuadratic :: adjust quadratic drag for thin columns   
...
C                        & Last iteration, in addition multiple of dumpFreq iter.
     ...
     & outputTypesInclusive, dumpInitAndLast, scaleBottomDragQuadratic
      ...
      LOGICAL scaleBottomDragQuadratic
...
C     bottomDragQuadraticMax :: maximum quadratic bottom-drag coefficient 
C               if scaling of coeff is used
C     bottomDragQuadraticScDepth :: column depth scale to adjust quadratic bottom-drag (m)
...
C     thinColDamp  :: implicit drag/damping parameter for thin columns
     ...
     & bottomDragQuadraticMax, bottomDragQuadraticScDepth,
     ...
     & ,thinColDamp
      ...
      _RL bottomDragQuadraticMax
      _RL bottomDragQuadraticScDepth 
