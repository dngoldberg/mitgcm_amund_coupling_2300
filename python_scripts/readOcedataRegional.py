...
def readOceDataRegional(PAS, ystart, yend, sub_dir, calc_bounds, calc_init):
    ...
    if ( calc_init == 'True' ):
        ...
        calc_init = False
    data = loadmat(f'zmod.mat',variable_names=['zMod'])
    zMod = data['zMod']
    ...
    data = loadmat(f'{sub_dir}/meshcoords.mat', 
    ...
    if calc_bounds:
        ...
        savemat(f'{sub_dir}/bdryDatapaholPy{PAS}.mat', bdry_data)
...
#                    Stemp = dataset_salt.variables["SALT"][start_month+n, :, :, :]
        ...
        savemat(f'{sub_dir}/initpaholPy{PAS}.mat', init_data)
    ...
    # if calc_bounds:
        # bdry_data = {
            ...
            # 'z': z
        # }
        # savemat(f'{sub_dir}/bdryDatapahol{PAS}.mat', bdry_data)
...
if __name__ == "__main__":
    readOceDataRegional(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6])
